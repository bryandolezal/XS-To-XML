...
xs_dir = os.path.abspath(config['converter_paths']['base_xs_directory'])  # Ensure it's an absolute path
xml_dir = os.path.abspath(config['converter_paths']['output_xml_directory'])  # Ensure it's an absolute path
